...
plt.rc('figure', figsize = (7,7))     # Configura o tamanho que a figura irá ser apresentada
...
fig.set_ylabel('Valor do Aluguel x Condominio')
fig.set_xlabel('Bairro')
fig.set_title("Valor Médio do Aluguel x Condominio por Bairro", {'fontsize':20})
plt.show()
