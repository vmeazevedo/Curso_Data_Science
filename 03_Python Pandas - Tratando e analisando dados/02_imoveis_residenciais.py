...
dados_residencial.to_csv('dados\\aluguel_residencial_1.csv', sep=';' , index=False)       # exportando o arquivo csv, usamos o index false para manter a formatação que ja fizemos anteriormente

dados_residencial_2 = pd.read_csv('dados\\aluguel_residencial_1.csv', sep=';')            # importamos o arquivo em um novo dataframe somente para teste.
